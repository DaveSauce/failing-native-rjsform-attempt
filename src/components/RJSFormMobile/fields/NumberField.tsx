...
export type NumberOptions = Omit<
  ...
  | "value"
>;
export type NumberFieldUiSchemaOptions = {
  "ui:options"?: NumberOptions;
  "ui:field": RJSFormFields.Number;
...
export const NUMBER_FIELD_INVALID_ERROR = "Please enter a valid number";
  ...
  return (
    <FieldBox>
      <InputComponent
        ...
        value={formData === undefined ? "" : String(formData)}
        // uiSchema features
